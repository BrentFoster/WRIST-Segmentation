...
Branches will (hopefully) roughly follow this github work flow with three branches a Master that always contains working code, a release branch when working towards the next version, and a Develop branch for adding and fixing features.
